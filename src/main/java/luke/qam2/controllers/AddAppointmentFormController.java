...
public class AddAppointmentFormController implements Initializable {
    ...
    /**
     * Saves a new appointment with the inputted data
     * @param event
     * @throws SQLException
     * @throws IOException
     */
    ...
    void saveAppointment(ActionEvent event) throws SQLException, IOException {
        ...
        //insert data
        PreparedStatement pstmt = HelperFunctions.connection.prepareStatement("INSERT INTO client_schedule.appointments(Title, Description, Location, Type, Start, End, Customer_ID, User_ID, Contact_ID) VALUES (?,?,?,?,?,?,?,?,?)");
